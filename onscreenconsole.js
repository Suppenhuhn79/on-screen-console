...
{let _={VERSION:"v1.3",ID:"on-screen-console",LOG_LEVEL:Number(/\bconsole=(\d)\b/i.exec(window.location.search)[1]),CSS:{"":"background-color:#fcfcfc;color:#777;font-family:monospace;font-size:0.8rem;position:fixed;top:0px;left:0px;width:100vw;margin:0px;padding:0px;box-sizing:border-box;z-index:"+Number.MAX_SAFE_INTEGER+";border:none;border-bottom:0.3rem solid #888;","ul":"list-style:none;margin:0rem;padding:0rem;color:#bbb;","input":"background-color:inherit;color:inherit;font-family:inherit;font-size:inherit;width:100%;border:none;outline:none;",".output":"padding:0px;margin:0px;max-height:30vh;overflow-y:scroll;",".output>div":"display:inline-block;min-width:100%;",".output>div>div:nth-child(1)":"float:left;margin-left:0.3em",".output>div>div:nth-child(2)":"margin-left:1.3em;",".output>div:not(.input)":"border-bottom:1px solid #eee;",".itm":"display:inline-block;white-space:pre;vertical-align:top;margin-right:0.7em;",".expandable:hover":"text-decoration:underline;cursor:pointer;","div.warn":"background-color:#fdfdd8;","div.error":"background-color:#fee8e8;",".internal,.boolean,.undefined":"color:#00f;",".string":"color:#777;",".number":"color:#2a2;",".object":"color:#3bd;",".function":"color:#6af;font-weight:bold;",".error":"color:#c44;",".objdesc":"color:#bbb;"},PREFIXES:{"error":"!","warn":"!","info":"i","input":"&gt;","result":"&lt;"}};if(_.LOG_LEVEL>0)
...
{case"window":objDesc=obj.location.toString();break;case"date":objDesc=obj.toString();break;case"array":objDesc="("+obj.length+")";break;};if(obj instanceof Element)
